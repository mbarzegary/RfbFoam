...
RfbFoam has been initially developed as part of the [`TopeSmash` project](https://mbarzegary.github.io/research/topesmash-intro/), but further contributions, either on the development of the core models or providing more supporting materials, are highly welcome. We welcome improvements, extensions, bug reports, and bug fixes to RfbFoam!  
...
5. Submit a pull request to the master repository (`mbarzegary/RfbFoam`).
